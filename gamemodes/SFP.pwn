...
public ProvjeriRacun(playerid)
{
    ...
    if(cache_num_rows() != 0)
    {
	   format(string1, (sizeof string1), "                                         {340000}DOBRODOŠAO NATRAG %s!\n{79B4B1}MOLIM VAS DA UNESETE LOZINKU KOJU STE IZABRALI NA REGISTRACIJI KAKO\nBI MOGLI PRISTUPITI SVOJIM PODACIMA TJ. KAKO BI MOGLI NASTAVITI SA\nIGROM! U SLUÈAJU BILO KAKVIH PROBLEMA ILI PITANJA S VEZI SERVERA\nKONTAKTIRAJTE NAŠU ADMINISTRACIJU!\n",GetName(playerid));
    ...
    {
	   format(string1, (sizeof string1), "                                         {340000}DOBRODOŠAO NA SERVER %s!\n{79B4B1}TVOJ NICK NIJE REGISTRIRAN NA OVOM SERVERU PA ÆEŠ GA SADA MORATI\nREGISTRIRATI! ODABERI LOZINKU KOJU ŽELIŠ I UKUCAJ JE OVDJE, PAZI DA\nSTAVIŠ LOZINKU KOJU ÆEŠ ZAPAMTITI! \n{950000}NAPOMENA: LOZINKU KOJU SADA UPIŠETE NEÆEMO JAVNO OBJAVLJIVATI NITI\nÆE VAS NAŠA ADMINISTRACIJA IKADA TRAŽITI DA NAM JE KAŽEŠ!\n",GetName(playerid));
